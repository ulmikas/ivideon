...
const Camera = ({ camera_name, description, total_views, preview, camera, server, height, width, img, rand, favorite, toggleView, onFavCLick }) => ((!preview)
  ?
    <li className={(preview) ? styles.cameraSelected : styles.camera}>
      <div onClick={toggleView} className={styles.image}>
        <img src={img} data-rand={rand} />
